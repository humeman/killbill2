 ...
 * @author cs
 */
public class BasicLocalDroppedItemState {
    private String id;
     ...
     */
	public BasicLocalDroppedItemState(final String id, final Coordinates location, final ItemType type, final int quantity) {
        this.id = id;
